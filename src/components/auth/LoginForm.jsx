      ...
      <div className="card">
        <div className="text-center mb-6">
          <div className="flex flex-col items-center gap-3 mb-2">
            <img src="/logo-picadito.png.jpg" alt="Logo" className="w-24 h-24 rounded-xl object-cover" />
            <h2 className="text-3xl font-bold text-black" style={{ fontFamily: '"Righteous", cursive' }}>
              Picadito App
            </h2>
          </div>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Inicia sesión para encontrar partidos
          </p>
        </div>
